...
import { EinClient, Event, Context, Queue } from '../../core/index.js';
        ...
        if (interaction.type === InteractionType.ApplicationCommand) {
            ...
            if (command.player) {
                if (command.player.voice) {
                    ...
                    if (
                        interaction.member.voice.channel.type === ChannelType.GuildStageVoice &&
                ...
                if (command.player.active) {
                    ...
                    if (!Queue.get(interaction.guildId).currentPlayable)
                        return await interaction.reply({
                            content: 'Nothing is playing right now.',
                        });
                }
